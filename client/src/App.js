    ...
    <div className="App">
      ...
      {showHome && (
        <div>
          ...
          <br /><br />
          <button className='menu-button' onClick={select1PlayerGame}><h1>1 Player Game</h1></button>
          <br /><br />
          <button  className='menu-button' onClick={select2PlayerGame}><h1>2 Player Game</h1></button>
          <br /><br />
          <button  className='menu-button' onClick={selectHowToPlay}><h1>How To Play</h1></button>
          <br /><br />
        </div>
      )}
